...
class bn_sucursal_cuenta extends _modelo_parent
{

    public function __construct(PDO $link, array $childrens = array())
    {
        $tabla = 'bn_sucursal_cuenta';
        $columnas = array($tabla => false, 'bn_banco' => $tabla, 'org_sucursal' => $tabla, 'org_empresa' => 'org_sucursal');
